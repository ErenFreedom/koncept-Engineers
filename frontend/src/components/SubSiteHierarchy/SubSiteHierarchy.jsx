...
const SubSiteHierarchy = ({ subsite, token, onRoomSelect }) => {
  ...
  const handleAddFloor = async (name) => {
    try {
      await addSubsiteFloor(name, token, subsite.id);
  ...
  const handleAddRoom = async (name) => {
    try {
      ...
      await addSubsiteRoom(activeFloorId, name, token, subsite.id);
  ...
  const handleDeleteFloor = async () => {
    try {
      await deleteSubsiteFloor(confirmDeleteFloor.id, token, subsite.id);
  ...
  const handleDeleteRoom = async () => {
    try {
      await deleteSubsiteRoom(confirmDeleteRoom.id, token, subsite.id);
