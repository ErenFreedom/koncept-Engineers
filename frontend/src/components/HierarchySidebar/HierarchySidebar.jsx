...
import ModalInput from "../ModelInput/ModelInput";
...
const HierarchySidebar = ({ onSiteSelect, onFloorExpand, onRoomSelect }) => {
  ...
  return (
    <>
      ...
      <div className={`hierarchy-sidebar ${isOpen ? "open" : ""}`}>
        ...
        {confirmDeleteRoom && (
          <div className="confirm-modal">
            <div className="confirm-modal-content">
              <p>
                Delete room <strong>{confirmDeleteRoom.name}</strong>?
              </p>
              <div className="modal-buttons">
                <button onClick={handleDeleteRoom} className="modal-confirm">
                  Yes
                </button>
                <button
        ...
        {confirmDeleteFloor && (
          <div className="confirm-modal">
            <div className="confirm-modal-content">
              <p>
                Delete floor <strong>{confirmDeleteFloor.name}</strong>?
              </p>
              <div className="modal-buttons">
                <button onClick={handleDeleteFloor} className="modal-confirm">
                  Yes
                </button>
                <button
